<%@ Page Title="XÓA NỘI DUNG" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="DelNational.aspx.cs" Inherits="Admin_DelNational" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">XÓA XUẤT XỨ HÀNG HÓA</h3>
        </div>
        <br />
        <br />
