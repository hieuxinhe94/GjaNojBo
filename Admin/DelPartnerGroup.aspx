<%@ Page Title="XÓA NỘI DUNG" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="DelPartnerGroup.aspx.cs" Inherits="Admin_DelPartnerGroup" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">XÓA NHÓM DANH BẠ</h3>
        </div>
        <br />
        <br />
