<%@ Page Title="XÓA NỘI DUNG" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="DelPartner.aspx.cs" Inherits="Admin_DelPartner" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">XÓA KHÁCH HÀNG, ĐỐI TÁC</h3>
        </div>
        <br />
        <br />
